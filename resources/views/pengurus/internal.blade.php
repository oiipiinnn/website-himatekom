        ...
        <div class="container">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 div-container col-md-8 col-sm-10">
                            <img class="img-fluid div-img" src="{{ asset('img/pengurus/internal.png') }}" alt="">
                        </div>
                    </div>
                ...
                <div class="col-lg-3 px-3 col-md-6 col-sm-6 p-0">
                    <div class="portfolio__item">
                        <div class="portfolio__item__video set-bg"
                            data-setbg="{{ asset('img/pengurus/nur.JPG') }}"
                        ...
                        <div class="portfolio__item__text">
                            <h4>Hafiz Nur</h4>
                            <span>Koordinator Divisi Internal</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="row  d-flex justify-content-center align-items-center">
                <div class="col-lg-3 px-1 col-md-6 col-sm-6 p-0">
                    <div class="portfolio__item">
                        <div class="portfolio__item__video set-bg"
                            data-setbg="{{ asset('img/pengurus/haikal.JPG') }}"
                            style="background-position: top !important; background-size: cover !important;"
                            >
                            <a href="#"></a>
                        </div>
                ...
                <div class="col-lg-3 px-1 col-md-6 col-sm-6 p-0">
                    <div class="portfolio__item">
                        <div class="portfolio__item__video set-bg"
                            data-setbg="{{ asset('img/pengurus/ani.JPG') }}">
                            <a href="#"></a>
                        </div>
                        <div class="portfolio__item__text">
                            <h4>Ani</h4>
                ...
                <div class="col-lg-3 px-1 col-md-6 col-sm-6 p-0">
                    <div class="portfolio__item">
                        <div class="portfolio__item__video set-bg"
                            data-setbg="{{ asset('img/pengurus/landy.JPG') }}"
                            style="background-position: top !important; background-size: cover !important;">
                            <a href="#"></a>
                        </div>
                        <div class="portfolio__item__text">
            ...
            <div class="row  d-flex justify-content-center align-items-center">
                <div class="col-lg-3 px-1 col-md-6 col-sm-6 p-0">
                    <div class="portfolio__item">
                        <div class="portfolio__item__video set-bg"
                            data-setbg="{{ asset('img/pengurus/fikri.JPG') }}"
                            style="background-position: top !important; background-size: cover !important;">
                            <a href="#"></a>
                        </div>
                        <div class="portfolio__item__text">
                ...
                <div class="col-lg-3 px-1 col-md-6 col-sm-6 p-0">
                    <div class="portfolio__item">
                        <div class="portfolio__item__video set-bg"
                            data-setbg="{{ asset('img/pengurus/fadhli.JPG') }}"
                            style="background-position: top !important; background-size: cover !important;">
                            <a href="#"></a>
                        </div>
                        <div class="portfolio__item__text">
                ...
                <div class="col-lg-3 px-1 col-md-6 col-sm-6 p-0">
                    <div class="portfolio__item">
                        <div class="portfolio__item__video set-bg"
                            data-setbg="{{ asset('img/pengurus/diaz.JPG') }}"
                            style="background-position: top !important; background-size: cover !important;">
                            <a href="#"></a>
                        </div>
                        <div class="portfolio__item__text">
